...
var ASM_CONSTS = {
  4551808: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 4551863: ($0) => { performance.now = function() { return $0; }; },  
 4551911: ($0) => { performance.now = function() { return $0; }; },  
 4551959: () => { performance.now = Module['emscripten_get_now_backup']; }
};
