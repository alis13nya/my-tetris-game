...
var ASM_CONSTS = {
  4554080: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 4554135: ($0) => { performance.now = function() { return $0; }; },  
 4554183: ($0) => { performance.now = function() { return $0; }; },  
 4554231: () => { performance.now = Module['emscripten_get_now_backup']; }
};
