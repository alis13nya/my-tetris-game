...
var ASM_CONSTS = {
  4562608: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 4562663: ($0) => { performance.now = function() { return $0; }; },  
 4562711: ($0) => { performance.now = function() { return $0; }; },  
 4562759: () => { performance.now = Module['emscripten_get_now_backup']; }
};
